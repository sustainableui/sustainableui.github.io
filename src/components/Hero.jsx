        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline bg-gradient-to-r from-lime-200 via-green-400 to-lime-200 bg-clip-text font-display text-5xl tracking-tight text-transparent">
                UIs redefined for the better.
              </p>
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Principally different approach to building frontends where the
                planet benefits the most while users remain at center.
              </p>
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                <Button href={`/#${slugify(props.title)}`}>Learn more</Button>
                <Button
                  href="https://taikai.network/gsf/hackathons/carbonhack22/projects/cl8j1ex3h2845301s653mtnk87/idea?utm_source=sustainableui.github.io"
                  variant="secondary"
                >
                  Carbon Hack 22 idea
                </Button>
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur">
                <div className="absolute -top-px left-20 right-11 h-px bg-gradient-to-r from-green-300/0 via-green-300/70 to-green-300/0" />
