...
export function Layout({ children, theme, title, tableOfContents }) {
      ...
      <div className="flex justify-center gap-x-6 bg-orange-600 px-4 py-2.5 sm:px-8">
        <p className="text-sm/6 text-white">
          <a href="https://samuelpitonak.sk" target="_blank" rel="noopener noreferrer">
            ...
            This project is abandoned. Contact owner if you&apos;re interested in acquiring this domain.&nbsp;<span aria-hidden="true">&rarr;</span>
          </a>
        </p>
      </div>
