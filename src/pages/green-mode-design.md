...
In addition to redefining what successful software, SUI is based on 2 green mode design principles: **graceful degradation** and **user control**.

Graceful degradation degrades performance of a software while retaining it's core functionality. User control is a core UX principle that places user at center of user experience of an app.
