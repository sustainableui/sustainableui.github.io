...
Sustainability is a comprehensive topic that is hard to tackle all at once. For this reason, SUI project has kicked off during Carbon Hack 22 with [a small solution](https://taikai.network/gsf/hackathons/carbonhack22/projects/cl8j1ex3h2845301s653mtnk87/idea?utm_source=sustainableui.github.io) that allows React web frontend developers to make web UIs carbon aware with more ease. The solution is a headless library built on top of [green mode design principles](/docs/green-mode-design).
